...
export function TransactionDetailModal({ visible, transaction, onClose, onDelete, onEdit }: any) {
  ...
  // Formatação simples da data para o layout
...
const styles = StyleSheet.create({
  ...
  iconCircle: { width: 70, height: 70, borderRadius: 35, backgroundColor: '#7BC67E', justifyContent: 'center', alignItems: 'center', marginBottom: 20, borderWidth: 1 },
